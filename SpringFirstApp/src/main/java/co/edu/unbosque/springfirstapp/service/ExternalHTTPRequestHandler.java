...
public class ExternalHTTPRequestHandler {
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    //		System.out.println(doPost("https://httpbin.org/post",
    // "{\"name\":\"mkyong\",\"notes\":\"hello\"}"));
    //		System.out.println("//// PUT ////");
    //		System.out.println(doPut("https://httpbin.org/put",
    // "{\"name\":\"mkyong\",\"notes\":\"hello\"}"));
  ...
  public static String doGetWithHeaders(String url) {
    HttpRequest request =
        HttpRequest.newBuilder()
            ...
            .header("Content-Type", "application/json")
            .setHeader(
                "X-Apikey", "b022b08d83bbbfd856d2f1e6080a08cc93a24c38db6537639d2c0b5bd84c0701")
            .build();
