 ...
 *
 * <p>Esta clase prueba la funcionalidad de autenticación proporcionada por el AuthController,
...
class AuthControllerTest {
  ...
  /**
   * Prueba que el endpoint de inicio de sesión incluya correctamente el rol del usuario en la
   * respuesta.
   *
   * <p>Esta prueba: 1. Crea un usuario de prueba con rol ADMIN 2. Simula el proceso de
   * autenticación 3. Llama al endpoint de inicio de sesión 4. Verifica que la respuesta contenga el
   * rol correcto
   *
  ...
  void testLoginReturnsRoleInResponse() throws Exception {
    ...
    assertEquals(
        true,
        responseJson.contains("\"role\":\"ADMIN\""),
        "La respuesta debe contener el rol ADMIN");
  }
}
