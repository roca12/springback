 ...
 * 
 * Esta clase contiene pruebas para verificar que el controlador de usuarios
 * funciona correctamente y maneja adecuadamente las solicitudes HTTP.
 * 
...
public class UserControllerTest {
     ...
     * 
     * Esta prueba verifica que el método createNewWithJSON devuelve un estado HTTP 201
     * y un mensaje de éxito cuando se crea un usuario correctamente.
     */
    @Test
     ...
     * 
     * Esta prueba verifica que el método createNewWithJSON devuelve un estado HTTP 406
     * y un mensaje de error cuando se intenta crear un usuario con un nombre que ya existe.
     */
    @Test
    public void testCreateNewWithJSONUserExists() {
        ...
        assertEquals("Error al crear el usuario, posiblemente el nombre de usuario ya está en uso", response.getBody());
    }

    /**
     * Prueba la obtención de todos los usuarios.
     * 
     * Esta prueba verifica que el método getAll devuelve una lista de usuarios
     * y un estado HTTP 200 cuando hay usuarios en el sistema.
     */
    @Test
