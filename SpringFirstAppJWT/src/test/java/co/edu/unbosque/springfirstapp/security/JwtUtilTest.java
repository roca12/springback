 ...
 * asegurando que la información del usuario se codifique y extraiga correctamente de los tokens.
 * 
...
public class JwtUtilTest {
    ...
    /**
     * Prueba que el rol del usuario se incluya correctamente en el token JWT generado
     * y que pueda ser extraído.
     * 
     * Esta prueba:
     * 1. Crea un usuario de prueba con rol ADMIN
     * 2. Genera un token JWT para el usuario
     * 3. Extrae el rol del token
     * 4. Verifica que el rol extraído coincida con el rol original
     */
    @Test
    public void testRoleIsIncludedInJwtToken() {
