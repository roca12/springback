 ...
 * 
 * Esta excepción se utiliza para indicar que una contraseña no cumple con los estándares
 * mínimos de seguridad requeridos por la aplicación, como longitud mínima, inclusión de
...
public class PasswordNotValidException extends Exception {
	 ...
	 * 
	 * El mensaje describe los requisitos mínimos que debe cumplir una contraseña válida.
	 */
	public PasswordNotValidException() {
		super("La contraseña no cumple con el estándar "
