...
/**
 * Clase de Objeto de Transferencia de Datos (DTO) para usuarios.
 * Utilizada para transferir datos de usuario entre capas de la aplicación,
 * especialmente en operaciones de API.
 */
public class UserDTO {
	 ...
	 * Crea una instancia vacía de UserDTO.
	 */
	public UserDTO() {
	}
	 ...
	 * Utilizado para almacenar objetos en colecciones basadas en hash.
	 * 
	 ...
	 * Dos objetos UserDTO son iguales si tienen el mismo id, username, password y role.
	 * 
	...
	/**
	 * Devuelve una representación en cadena de texto de este objeto.
	 * Útil para depuración y registro.
	 * 
