...
/**
 * Clase inicializadora de Servlet para desplegar la aplicación Spring Boot como un archivo WAR
 * en un contenedor de servlet externo.
 * 
 * Esta clase extiende SpringBootServletInitializer, que es un WebApplicationInitializer
 * opinado para ejecutar una SpringApplication desde un despliegue WAR tradicional.
 * 
